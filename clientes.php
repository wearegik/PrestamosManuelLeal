...
<body>
<form  class="contact_form" action="busquedacliente.php" id="contact_form" runat="server">  
        <div>  
            <ul>  
                <li>  
                ...
                <li>  
                    ...
                    <?php 
                        ...
                        $query = 'SELECT cliente.* from cliente JOIN prestamo ON cliente.idcliente = prestamo.idcliente AND prestamo.Prestamoya =1 ORDER BY cliente.Nombres ASC';
